...
=head1 OUTPUT FUNCTIONS
  ...
  $str = dd_repro($obj); # "repro" short for "reproducible"
   ...
   Math::FakeDD object will be identical to (ie a reproduction
...
=head1 ARITHMETIC IMPLEMENTATION
  ...
  Operands are first converted to a 2098-bit value (Math::MPFR object).
  ...
  DoubleDouble implementation.
  Thus we see that double rounding can occur.
